...
ShellBot.InlineKeyboardButton --button 'botao_user' --line 2 --text ' Contacto WTS 📲' --callback_data  '1' --url "https://wa.me/$(cat < /etc/numctc)$(cat < /etc/numsg)"
...
ShellBot.InlineKeyboardButton --button 'botao_donar' --line 2 --text 'ACCEDER WHATSAPP' --callback_data '1' --url "https://wa.me/$(cat < /etc/numctc)$(cat < /etc/numsg)"
